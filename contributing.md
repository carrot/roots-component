# Contributing to Roots-component
...
## Code Style
To keep a consistent coding style in the project, we're using [Polar Mobile's guide](https://github.com/polarmobile/coffeescript-style-guide). For any inline documentation, we're using [JSDoc](http://usejsdoc.org/).
